...
authorUsageWithYear |>
  ...
  geom_point(size = 2) +
  ggtitle('UT Knoxville Articles per Year by Author Count') +
  xlab('Year') +
  ylab('# Articles') +
  labs(fill = '# Authors') +
...
ggsave('FIG7.jpeg', width = 8, height = 4, units = 'in', dpi = 300)
```
...
ggplot(publicationYearData, aes(x = `Publication Year`, y = n, colour = publisherGroup)) +
  ...
  ggtitle('Where UT Knoxville Researchers Publish') +
  xlab('Year') +
  ylab('# Articles') +
...
ggsave('FIG8.jpeg', width = 8, height = 4, units = 'in', dpi = 300)
```
...
ggsave('FIG9.jpeg', width = 8, height = 4, units = 'in', dpi = 300)
```
...
ggsave('FIG4.jpeg', width = 7, height = 3.5, units = 'in', dpi = 300)
```
...
ggsave('FIG1.jpeg', width = 8, height = 4, units = 'in', dpi = 300)
```
...
ggsave('FIG5.jpeg', width = 8, height = 4, units = 'in', dpi = 300)
```
...
ggsave('FIG6.jpeg', width = 8, height = 4, units = 'in', dpi = 300)
```
...
ggplot(longerSector, aes(x = Year, y = Spending_Diff_GDP, colour = Nation)) +
  ...
  ggtitle('Yearly Changes in Research and Development Spending') +
  xlab('Year') +
...
ggsave('FIG2.jpeg', width = 8, height = 4, units = 'in', dpi = 300)
```
...
ggsave('FIG3.jpeg', width = 8, height = 4, units = 'in', dpi = 300)
```
